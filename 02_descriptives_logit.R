...
# Clean workspace and set language & start.time
rm(list = ls(all = TRUE))
Sys.setenv(LANG = "en")
start_time <- Sys.time()
...
summary(logit_baseline <- glm(formula  = formula_baseline,
...
# Clean up
# NOTE: ame_df is kept (used by the profile-specific Figure 3 in stage 04).
